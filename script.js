...
const SCHOOL = "MyCollege";
// SCHOOL = "I will cause an error";
// declaring a variable with const, make it a constant that you cant change later in the code.
...
console.log(2+"3")
console.log(2+3)
// Adding a string with a number will concatenate them together as a string.
...
console.log("If you add 2 and 5 you will get: ", add(2,5))
...
console.log("Displaying var a :", a)
//console.log("Displaying let b :", b)
// let b will cause an error so I wil comment it.
